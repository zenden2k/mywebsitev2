<template>
    <div>
        <section class="content-header"><div class="container-fluid"><h1>Sidebar Blocks</h1></div></section>
...
<button type="submit" class="btn btn-info btn-flat">Go!</button>
                ...
                <div class="mb-2">
                    <router-link :to="{name: 'addsidebarblock'}" tag="button" class="btn btn-info"><i class="fa fa-plus"></i> Add Sidebar Block</router-link>
                </div>
                    <div class="">
                        <div class="card">
<!--                            <div class="card-header">-->
                                    ...
                                    <tr v-for="item in laravelData.data" :key="item.id">
                                       ...
                                       <td>
                                            <div class="btn-group" role="group">
                                                <router-link :to="{name: 'editsidebarblock', params: { id: item.id }}" class="btn btn-primary">Edit</router-link>
